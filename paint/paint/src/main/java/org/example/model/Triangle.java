...
public class Triangle extends Shape {
    ...
    public void fromDocument(Document doc) {
        ...
        this.x3 = doc.getDouble("x3").floatValue();
        this.y3 = doc.getDouble("y3").floatValue();
    }
    ...
    public JPanel createEditorPanel(Runnable repaintCallback) {
        ...
        JTextField x3f = new JTextField(String.valueOf(x3));
        x3f.addActionListener(e -> { this.x3 = Float.parseFloat(x3f.getText()); repaintCallback.run(); });
        panel.add(x3f);
        panel.add(new JLabel("Y3:"));
        JTextField y3f = new JTextField(String.valueOf(y3));
        y3f.addActionListener(e -> { this.y3 = Float.parseFloat(y3f.getText()); repaintCallback.run(); });
        panel.add(y3f);
